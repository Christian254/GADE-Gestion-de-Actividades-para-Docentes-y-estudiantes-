...
public class SpinnerAdapter extends ArrayAdapter<Escuela> {
    private Context context;

    List<Escuela> datos = null;

    public SpinnerAdapter(Context context, List<Escuela> datos)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        ((ImageView) convertView.findViewById(R.id.icono)).setBackgroundResource(R.drawable.escuela);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (row.getTag() == null)
        {
            EscuelaHolder escuelaHolder = new EscuelaHolder();
