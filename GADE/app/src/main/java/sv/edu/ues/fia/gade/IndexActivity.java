    ...
    **/
    private void cargarMenu(int t) {
        if(t==2){ //si es administrador podra:
            String[] menu1= {"Gestionar Escuela", "Gestionar Estudiante" ,"Solicitar Local", "Consultar Reservas","Modificar Reserva", "Eliminar Reservas","Gestionar Administrador","Gestionar Local","Gestionar Horario"};
            String[] valores1={"EscuelaGestionarActivity", "EstudianteGestionarActivity" ,"SolicitarLocalActivity", "ConsultarReservaActivity","ModificarReservaActivity", "EliminarReservaActivity","GestionarAdminActivity","GestionarLocalActivity","GestionarHorarioActivity"};
            this.menu=menu1;
